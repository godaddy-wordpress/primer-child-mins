...
function mins_search_toggle() {
	...
	wp_enqueue_script( 'mins-search-nav', get_stylesheet_directory_uri() . '/assets/js/search-nav.js', array( 'jquery' ), PRIMER_VERSION, true );
 ...
 * @since  1.0.0
 *
 * @param  array $font_types Font types.
 *
 * @return array
 */
